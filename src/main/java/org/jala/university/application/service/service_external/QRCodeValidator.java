...
public class QRCodeValidator {
    ...
    // Valida o campo 'accountReceiver', que deve ser um número válido
    public static boolean isValidAccount(String accountReceiver) {
        return accountReceiver != null && accountReceiver.matches("\\d+");
    }

    // Valida o campo 'agencyReceiver', que deve ser um número válido
    public static boolean isValidAgency(String agencyReceiver) {
        return agencyReceiver != null && agencyReceiver.matches("\\d+");
    }

    // Valida o campo 'expirationDate' que deve ser uma data válida no formato 'yyyy-MM-dd'
    public static boolean isValidExpirationDate(String expirationDate) {
        try {
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            Date date = sdf.parse(expirationDate);
            return expirationDate.equals(sdf.format(date)); // Verifica se a data tem o formato correto
...
//        }
//
//        // Alterei o formato da data para 'yyyy-MM-dd'
//        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
