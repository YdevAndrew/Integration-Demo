...
public interface FormEntityService {
    ...
    /**
     * Retorna o ID da conta do usuário logado.
     * <p>
     * Utiliza a autenticação do Spring Security para recuperar o CPF do usuário
     * e buscar a conta correspondente.
     * </p>
     *
     * @return o ID da conta do usuário logado ou null caso não esteja autenticado.
     */
