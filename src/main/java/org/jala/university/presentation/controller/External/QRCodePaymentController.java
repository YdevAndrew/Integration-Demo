...
//                cnpjReceiver = QRCodeValidator.formatCNPJ(json.getString("cnpjReceiver"));
    ...
    public void onConfirmButtonClick(ActionEvent event) {
        if (amount > 0 && receiverName != null && !receiverName.isEmpty() &&
            ...
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/External/gui/ManualPaymentScreens/ManualPaymentInformation/ManualPaymentInformation.fxml"));
    ...
    public void onManualEntryClick(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/External/gui/ManualPaymentScreens/QRCodePayment/ManuallyInsert.fxml"));
