...
public class QRCodePaymentController extends BaseController {
    ...
    public BigDecimal amount; // Alterado para BigDecimal
    ...
    public void decodeQRCode(File file) {
        try {
            ...
            try {
                ...
                // Convertemos amount para BigDecimal
                amount = new BigDecimal(json.getString("amount"));
                cnpjReceiver = json.getString("cnpjReceiver").replaceAll("[^0-9]", ""); // Apenas números no CNPJ
    ...
    public void onConfirmButtonClick(ActionEvent event) {
        this.event = event;
        // Usando compareTo() para comparar BigDecimal
