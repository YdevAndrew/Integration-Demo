...
public class SchedulePaymentController extends BaseController {
    ...
    public void initialize() {
        ...
        accountField.textProperty().addListener((obs, oldText, newText) -> {
            ...
            if (plainText.length() >= 6) {
                ...
                accountField.positionCaret(accountField.getText().length());
            } else {
    ...
    public boolean validateAllFields() {
        ...
        try {
            // Parse the amount to BigDecimal
    ...
    private void schedulePaymentInformation() throws IOException {
        if (validateAllFields()) {
            ...
            // Pass the data to SchedulePaymentInformationController
            controller.setPaymentData(
                    serviceNameField.getText(),
                    recipientField.getText(),
                    amount, // Now passing BigDecimal instead of String
                    agencyField.getText(),
