...
public class ManualPaymentInformationController {
    ...
    private void onConfirmButtonClick() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/password/PasswordPrompt.fxml"));
    ...
    public void showPaymentReceipt() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/PaymentReceipt/PaymentReceipt.fxml"));
