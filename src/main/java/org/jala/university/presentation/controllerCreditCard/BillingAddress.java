...
import org.jala.university.application.object.SaveBillingAddress;
...
public class BillingAddress extends BaseController {
    ...
    public void loadFinancialPage() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/personal_financial_information/Form_financial_info.fxml"));
            ...
            if (root != null) {
                scene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("/gui/billing_address/style.css")).toExternalForm());
