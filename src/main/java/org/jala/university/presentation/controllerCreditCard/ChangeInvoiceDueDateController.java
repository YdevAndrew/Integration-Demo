        ...
        try {
            ...
            if (toggleGroup.getSelectedToggle() != null) {
                ...
                if (CreditCardClientService.updatePaymentIsAvaliable(CardsPageController.getCardClicked())) {
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/creditCardFXMLs/changeInvoiceDueDate/sucess_modal.fxml"));
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/creditCardFXMLs/changeInvoiceDueDate/fail_modal.fxml"));
                    Parent root = loader.load();
