...
public class DashboardController extends BaseController {
    ...
    private void loadMyCards() throws IOException {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/creditCardFXMLs/creditCardFXMLs/cards/cards_page.fxml"));
    ...
    private void loadInvoiceHistory() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/creditCardFXMLs/invoiceHistory/invoice_history.fxml"));
