...
import org.jala.university.services.endpoint.services.AddCustomLimitService;
...
public class ModalAdjustLimit {
    ...
    private void increaseLimit(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/creditCardFXMLs/increaseLimit/modal-increase-limit.fxml"));
